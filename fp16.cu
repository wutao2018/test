...
__global__ void fp16gemm_32x32_tensor4_N8(float *A, float *B, float *C, int M, int N, int K, float alpha, float beta) {
...
__global__ void fp16gemm_32x32_tensor4_N8_K16(float *A, float *B, float *C, int M, int N, int K, float alpha, float beta) {
...
__global__ void fp16gemm_32x32_tensor4_M1_N8(float *A, float *B, float *C, int M, int N, int K, float alpha, float beta) {
...
int main(int argc, char* argv[]) 
{
   ...
   dim3 gridDim6;
   dim3 blockDim6;
   gridDim6.x = MATRIX_M/32; gridDim6.y = MATRIX_N/32 + 1; gridDim5.z = 1;
   blockDim6.x = 128; blockDim6.y = 1; blockDim6.z = 1; 
   ...
   fp16gemm_32x32_tensor4_N8<<< gridDim5, blockDim5 >>>(a_fp32, b_fp32, c_wmma, MATRIX_M, MATRIX_N, MATRIX_K, alpha, beta);
   //fp16gemm_32x32_tensor4_N8_K16<<< gridDim5, blockDim5 >>>(a_fp32, b_fp32, c_wmma, MATRIX_M, MATRIX_N, MATRIX_K, alpha, beta);
   //fp16gemm_32x32_tensor4_M1_N8<<< gridDim5, blockDim5 >>>(a_fp32, b_fp32, c_wmma, MATRIX_M, MATRIX_N, MATRIX_K, alpha, beta);
