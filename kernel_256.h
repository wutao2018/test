...
__device__ void gemm_256_32x32_16(int M, int N, int K, float *A, float *B, float *C, int block_base_y, int block_base_x, float *sh){

	float *sh_A = sh;
	float *sh_B = sh + 2*32*16;
...
__device__ void gemm_256_64x64_16(int M, int N, int K, float *A, float *B, float *C, int block_base_y, int block_base_x, float *sh){
...
__device__ void gemm_256_128x64_16(int M, int N, int K, float *A, float *B, float *C, int block_base_y, int block_base_x, float *sh){
...
__device__ void gemm_256_64x128_16(int M, int N, int K, float *A, float *B, float *C, int block_base_y, int block_base_x, float *sh){
	...
	//load A from global memory to shared memory
	float4 *A_start = (float2*) (A + block_base_y + (threadIdx.x%16)*4 + (threadIdx.x/16)*M); 
	*((float4*) (sh_A + 4*threadIdx.x)) = *(A_start);
...
__device__ void gemm_256_128x128_16(int M, int N, int K, float *A, float *B, float *C, int block_base_y, int block_base_x, float *sh){
